/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db5cfed619be30be549aeafb4259942c)
// Runtime types generated with workerd@1.20260312.1 2024-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserProfileDO";
	}
	interface Env {
		BRIEFINGS: KVNamespace;
		AI: Ai;
		USER_PROFILE: DurableObjectNamespace<import("./src/index").UserProfileDO>;
